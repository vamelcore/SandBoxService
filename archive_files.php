...
$_SESSION['lastpagevizitadm'] = 'archive_files.php';
...
<p style="font-size:12px;">Архив сохраненных файлов</p>
</td></tr>
	...
	<table cellpadding="0" cellspacing="0" border="0" id="table" class="sortable">
		<thead>
			<tr>
				...
				<th width="300"><h3>Имя файла</h3></th>
				<th width="75"><h3>Дата добавления</h3></th>
			</tr>
		</thead>
		<tbody>
<?php
...
$iterator = 0;
while (isset($files_array[$iterator])) {
	printf("<tr><td width=15 align='center'><img onClick=\"top.location.href='PAYment/insert_files.php?diler=%s';\" src='/images/del_icon.png' width='20' height='20' border='0'></td><td>%s</td><td>%s</td></tr>",$files_array[$iterator],$files_array[$iterator],$dates_array[$iterator]);
$iterator++;
}
...
<div id="controls">
		<div id="perpage">
			...
			<option value="5">5</option>
				...
				<option value="<?php echo $iterator; ?>">Все</option>
			</select>
...
<tr><td style="border-bottom:1px solid #c6d5e1;">
<p>Всего записей на этой странице: <?php echo $iterator; ?></p>
</td></tr>
  </table>
