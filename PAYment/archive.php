...
<?php include ("../config.php"); session_start(); if (isset($_SESSION['xls_data_array'])) {unset($_SESSION['xls_data_array']);} if (isset($_SESSION['diler_array'])) {unset($_SESSION['diler_array']);}?>
...
?>
<p style="font-size:14px;"><?php if ($error_insert_flag == false) {printf('Файл <strong>%s</strong> был успешно добавлен в архив',$filename);} ?>&nbsp;&nbsp;&nbsp;<input type="button" value="<- Назад к загрузке" onClick="top.location.href='uploader.php'" style="width:160px; height:25px; font-size:14px;"></p>
</br>
</td>
</tr>
<tr>
